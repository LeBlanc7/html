<?php
   // 회원가입 정보를 DB의 회원테이블(MEM)에 입력하는 쿼리를 담은 php 파일

    include $_SERVER['DOCUMENT_ROOT'].'/dbconnect.php';
   // Parse SQL
    $confirm = "SELECT * FROM MEM WHERE MEM_ID='$_POST[id]'";
    ...
    if(oci_fetch_assoc($result))
    {
    	...
    	$query = "INSERT INTO MEM (MEM_ID,MEM_PW,MEM_NM,PH_NUM,BTDY,PNT) VALUES ('$_POST[id]','$_POST[pw]','$_POST[mem_nm]','$_POST[ph_num]','$_POST[btdy]','0')";
